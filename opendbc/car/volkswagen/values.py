...
class CarControllerParams:
  ...
  STEER_TIME_BM = 200                      # Attempts to mitigate the EPS max steer timer begin
  ...
  STEER_TIME_LOW_TORQUE = 1.2              # Wait for this duration of STEER_LOW_TORQUE to begin mitigation
