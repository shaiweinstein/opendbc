...
class CarControllerParams:
  ...
  STEER_TIME_BM = STEER_TIME_MAX - 240     # Attempts to mitigate the EPS max steer timer begin
  STEER_TIME_ALERT = STEER_TIME_MAX - 10   # If mitigation fails, time to soft disengage before EPS timer expires
  STEER_LOW_TORQUE = int(STEER_MAX * 0.18) # Steer timer mitigation performed when torque output under 18%
  STEER_TIME_LOW_TORQUE = 0.7              # Wait for this duration of STEER_LOW_TORQUE to begin mitigation
